...
interface LoginPageLayoutProps {
  ...
  /** Panel de marca a mostrar; por defecto el del login. */
  panel?: React.ReactNode;
}

/**
 * Vista de autenticación: mobile-first (columna marca → formulario), desktop dos columnas.
 */
